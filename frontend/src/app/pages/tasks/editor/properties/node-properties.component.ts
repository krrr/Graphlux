                ...
                <div class="props-area">
                    ...
                    <div class="ant-form">
                        @switch (node().type) {
                            ...
                            @case ('ConvertNode') {
                                <app-convert-props [nodeId]="node().id" />
                            }
                            @case ('CodeEvalNode') {
                                <app-code-eval-props [nodeId]="node().id" />
                            }
                            @case ('ConditionNode') {
                                <app-condition-props [nodeId]="node().id" />
                            }
                            @case ('FileOperationNode') {
                                <app-file-operation-props [nodeId]="node().id" />
                            }
                            @case ('MetadataWriteNode') {
                                <app-metadata-write-props [nodeId]="node().id" />
                            }
                            @case ('CallTaskNode') {
                                <app-props-call-task [nodeId]="node().id" />
                            }
                            @case ('FinishNode') {
