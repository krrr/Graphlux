...
@Component({
    ...
    template: `
        <ng-container *transloco="let t">
            <nz-form-item>
                ...
                <nz-form-control>
                    <nz-select
                        ...
                        [nzPlaceHolder]="t('props.placeholder_select_source')"
                        name="input_file_var"
                    >
            ...
            <nz-form-item>
                <nz-form-label>{{ t('props.format') }}</nz-form-label>
                <nz-form-control>
                    <nz-select [ngModel]="config().format || 'custom'" (ngModelChange)="onFormatChange($event)" name="format">
                        <nz-option nzValue="custom" [nzLabel]="t('props.custom')"/>
            ...
            @if ((config().format || 'custom') !== 'custom') {
                <nz-form-item>
                    <nz-form-label [nzTooltipTitle]="t('props.quality_tooltip')">
                        {{ t('props.quality') }}
                    </nz-form-label>
                    <nz-form-control>
                        <nz-input-number
                ...
                @if (config().format === 'avif') {
                    <nz-form-item>
                        <nz-form-label [nzTooltipTitle]="t('props.speed_tooltip')">
                            {{ t('props.speed') }}
                        </nz-form-label>
                        <nz-form-control>
                            <nz-input-number
                    ...
                    <nz-form-item>
                        <nz-form-label [nzTooltipTitle]="t('props.chroma_tooltip')">
                            {{ t('props.chroma') }}
                        </nz-form-label>
                        <nz-form-control>
                    ...
                    <nz-form-item>
                        <nz-form-label [nzTooltipTitle]="t('props.lossless_tooltip')">
                            {{ t('props.lossless') }}
                        </nz-form-label>
                        <nz-form-control>
                            <nz-switch
            ...
            @if ((config().format || 'custom') === 'custom') {
                <nz-form-item>
                    <nz-form-label>{{ t('props.tool') }}</nz-form-label>
                    <nz-form-control>
                ...
                <nz-form-item>
                    <nz-form-label>{{ t('props.target_extension') }}</nz-form-label>
                    <nz-form-control>
                        <input
                            nz-input
                ...
                <nz-form-item>
                    <nz-form-label>{{ t('props.arguments') }}</nz-form-label>
                    <nz-form-control>
                        <input
                            nz-input
